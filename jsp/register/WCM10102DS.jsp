    ...
    <div class="wrap">
        ...
        <div class="bodyWrap" id="EncryptionAreaID_0" role="main">    
            <main class="contentWrap" style="">
                ...
                <section class="page-container login ie04 showInfo">
                ...
                <nav class="tab-list depth1">
                    <div class="btn-group">
                        ...
                        <a href="javascript:goMenuFnc('로그인','','','N','../register/WCM10101DS.jsp');" class="tab-item " id="certFina">금융인증서</a>
                            --> 
                        <a href="javascript:goMenuFnc('로그인','','','Y','../register/WCM10102DS.jsp');" class="tab-item active" id="certIpin">휴대폰인증</a> 
                        <a href="javascript:goMenuFnc('로그인','','','Y','../register/WCM10103DS.jsp');" class="tab-item " id="certPriv">민간(사설)인증서</a> 
                        ...
                        <!-- // 휴대폰본인인증 -->
                            <div id="" class="tab-panel" aria-hidden="false">
                                    
                                <fieldset class="form-content">
                                    <legend>휴대폰인증 로그인</legend>
                                        
                                </fieldset>
                                <!--S : 2025-12-02 -> 버튼위치 변경 및 명칭변경-->
                                <div class="btn-content login phone hploginbasic" style="display: none;">
                                    <div class="button-group">
                                        <a href="javascript:void(0);" class="btn-primary hplogincntrl">휴대폰 인증 로그인</a> 
                                    </div>
                                    <div class="button-group">
                                        <a href="javascript:goMenuFnc('휴대폰정보변경','','','Y','/mgcap/register/WCM40201VS.jsp');">휴대폰정보변경 바로가기</a>
                                        <a href="javascript:goMenuFnc('회원가입','','','N','/mgcap/register/WCM40100DS.jsp');">회원가입 바로가기</a>
                                    </div>
                                    <div class="note-content">
                                        <ul>
                                            <li>휴대폰번호 변경되었다면, 휴대폰정보변경 바로가기 클릭!</li>
                                        </ul>
                                    </div>
                                </div>
                                <!--E : 2025-12-02 -> 공동인증서 안내 및 위치 바꾸기-->
                                    
                                <!-- s : 휴대폰인증 영역  -->
                                <!-- s : hide 1 -->
                                <div class="form-content hploginhide" style=""> 
                                    <h3>약관동의</h3>
                                        
                                    <div class="form-group">
                                        <ul class="check-box terms">
                                            <li class="check-all-area">
                                                <input type="checkbox" id="chkAll">
                                                <label for="chkAll" class="check-button">
                                                    <span>전체 약관에 동의합니다.</span>
                                                </label>
                                            </li>
                                            <li class="term_hide_cntrl">
                                                <input type="checkbox" id="hpChk1" name="hpChk1" class="chkReq">
                                                <label for="hpChk1" class="check-button" data-open-bak="fullPopup1">
                                                    <span>개인정보 수집·이용·취급위탁 동의</span>
                                                </label>
                                                <button title="개인정보 수집·이용·취급위탁 동의 내용보기" type="button" class="modal" data-popup-open="fullPopup1">내용보기</button>
                                            </li>
                                            <li class="term_hide_cntrl">
                                                <input type="checkbox" id="hpChk2" name="hpChk2" class="chkReq">
                                                <label for="hpChk2" class="check-button" data-open-bak="fullPopup2">
                                                    <span>본인확인서비스 이용약관 동의</span>
                                                </label>
                                                <button title="본인확인서비스 이용약관 내용보기" class="modal" type="button" data-popup-open="fullPopup2">내용보기</button>
                                            </li>
                                            <li class="term_hide_cntrl">
                                                <input type="checkbox" id="hpChk3" name="hpChk3" class="chkReq">
                                                <label for="hpChk3" class="check-button" data-open-bak="fullPopup3">
                                                    <span>고유식별정보처리 동의</span>
                                                </label>
                                                <button title="고유식별정보처리 동의 내용보기" class="modal" type="button" data-popup-open="fullPopup3">내용보기</button>
                                            </li>
                                            <li class="term_hide_cntrl">
                                                <input type="checkbox" id="hpChk4" name="hpChk4" class="chkReq">
                                                <label for="hpChk4" class="check-button" data-open-bak="fullPopup4">
                                                    <span>통신사 이용약관 동의</span>
                                                </label>
                                                <button title="통신사 이용약관 동의 내용보기" class="modal" type="button" data-popup-open="fullPopup4">내용보기</button>
                                            </li>
                                            <li class="term_hide_cntrl">
                                                <input type="checkbox" id="hpChk5" name="hpChk5" class="chkReq">
                                                <label for="hpChk5" class="check-button" data-open-bak="inc_term_09">
                                                    <span>제3자 정보제공동의</span>
                                                </label>
                                                <button title="통신사 이용약관 동의 내용보기" class="modal" type="button" data-popup-open="inc_term_09">내용보기</button>
                                            </li>
                                        </ul>
                                    </div>
                                    <!-- e : hide 1 -->
                                ...
                                <form name="frm_MAIN" method="post">
                                    ...
                                    <input name="pssf_athn_dspt_seq" type="hidden" value="">
                                    <input name="authYn" id="authYn" type="hidden">
                                    <input name="brth_dt" id="brth_dt" type="hidden">
                                    <!--
                                    <input type="radio" name="keyPadTypeSelect" value="qwertysmart" style="visibility: hidden;"></input>
                                    <input type="radio" name="keyPadTypeSelect" value="number" checked="checked" style="visibility: hidden;"></input>
                                    <input type="checkbox" name="hpChk1" id="hpChk1" checked="checked" style="visibility: hidden;"/>
                                    <input type="checkbox" name="hpChk2" id="hpChk2" checked="checked" style="visibility: hidden;"/>
                                    <input type="checkbox" name="hpChk3" id="hpChk3" checked="checked" style="visibility: hidden;"/>
                                    <input type="checkbox" name="hpChk4" id="hpChk4" checked="checked" style="visibility: hidden;"/>
                                    <input type="checkbox" name="hpChk5" id="hpChk5" checked="checked" style="visibility: hidden;"/>
                                    -->
                                    
                                    <!-- s : hide 2 -->
                                    <div class="form-container pt-52 hploginhide" style="">
                                        ...
                                        <fieldset class="form-content mt-42">
                                            ...
                                            <div class="form-wrap">
                                                <div class="form-group">
                                                    <p class="label-tit">이름</p>
                                                    <label for="CUST_NM" class="sr-only">이름</label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="flex-row">
                                                        <span class="txt-unit">
                                                            ...
                                                            <input maxlength="4" id="year" name="year" type="number" inputmode="numeric" oninput="formattedYear(this)" required="">
                                                            <span class="txt">년</span>
                                                        </span>
                                                        <span class="txt-unit">
                                                            <label for="month" class="sr-only">생년월일 월</label>
                                                            <input maxlength="2" id="month" name="month" type="number" inputmode="numeric" oninput="formattedMonth(this)" required="">
                                                            <span class="txt">월</span>
                                                        </span>
                                                        <span class="txt-unit">
                                                            <label for="day" class="sr-only">생년월일 일</label>
                                                            <input maxlength="2" id="day" name="day" type="number" inputmode="numeric" oninput="formattedDay(this)" required="">
                                            ...
                                            <div class="form-wrap">
                                                <div class="form-group">
                                                    ...
                                                    <label class="radio button">
                                                        <input type="radio" name="gend" id="gend" value="0">
                                                        <span>여자</span>
                                                    </label>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="flex-row column">
                                                        <div>
                                                            ...
                                                            <select id="TEL_CMM_CD" class="flw-100" name="TEL_CMM_CD" required="">
                                                        ...
                                                        <div>
                                                            <label for="CELL_NO1" class="sr-only">휴대폰 앞자리</label>
                                                            <select id="CELL_NO1" name="CELL_NO1" required="">
                                                            ...
                                                            <label for="CELL_NO2" class="sr-only">휴대전화번호 중간자리</label>
                                                            <input id="CELL_NO2" name="CELL_NO2" onkeyup="inputNUMFormat(this,4);" type="tel" inputmode="numeric" class="pc-phn" autocomplete="tel-local-prefix" pattern="[0-9]{3,4}" maxlength="4" value="">
                                                            <label for="CELL_NO3" class="sr-only">휴대전화번호 뒷자리</label>
                                                            <input id="CELL_NO3" name="CELL_NO3" type="tel" inputmode="numeric" class="pc-phn" autocomplete="tel-local-suffix" pattern="[0-9]{4}" maxlength="4" value="" readonly="true" onfocus="viewKeypad(this, 0, 4);">
                                                            ...
                                                            <!--[D]:공통 - 알럿참고 -->
                                                            <button type="button" class="btn-form reCertReqNum" onclick="javascript:goConfirmCellNo();">인증번호 요청</button>
                                                        </div>
                                                    </div><!--//flex-row-->
                                                </div><!--//form-group-->
                                            </div><!--//form-wrap-->
                                            <div class="form-wrap">
                                                <div class="form-group">
                                                    <p class="label-tit">인증번호</p>
                                                    <label for="SMS_CERT_NO" class="sr-only">인증번호</label>
                                                    <div class="flex-row mo-column">
                                                        <input id="SMS_CERT_NO" name="SMS_CERT_NO" onkeyup="inputNUMFormat(this,6);" type="text" placeholder="인증번호를 입력해주세요" readonly="readonly">
                                                        <button type="button" class="btn-form" onclick="javascript:goConfirmAuthNo();">확인</button>
                                                    </div>
                                                    <span id="smsDtimer" class="mt-10 point-r" style="display:inline-block"></span>
                                                </div><!--//form-group-->
                                            </div>
                                        </fieldset>
                                    </div> 
                                ...
                                <form name="joinform2" method="post" target="hiddenFrame">
                                    <input type="hidden" name="mbphn_no">
                                    <input type="hidden" name="name">
                                    <input type="hidden" name="tel_cmm_cd">
                                    <input type="hidden" name="cell_no1">
                                    <input type="hidden" name="cell_no2">
                                    <input type="hidden" name="cell_no3">
                                    <input type="hidden" name="sms_re_snd_yn">
                                    <input type="hidden" name="svc_tx_seqno">    
                                    <input type="hidden" name="smsRsdn">	    
                                    <input type="hidden" name="gend">	    
                                    <input type="hidden" name="year">	    
                                    <input type="hidden" name="month">	    
                                    <input type="hidden" name="day">	    
                                    <input type="hidden" name="ntv_frnr"> 
                                            
                                    <input type="hidden" name="xksessionid2" id="xksessionid2">
                                    <input type="hidden" name="xksectoken2" id="xksectoken2">
                                    <input type="hidden" name="xkindexed2" id="xkindexed2">		
                                </form>
                                <form name="joinform3" method="post" target="hiddenFrame">
                                    <input type="hidden" name="checkVer">
                                    <input type="hidden" name="mbphn_no">
                                    <input type="hidden" name="cell_no1">
                                    <input type="hidden" name="cell_no2">
                                    <input type="hidden" name="cell_no3">
                                    <input type="hidden" name="sms_cert_no">
                                    <input type="hidden" name="svc_tx_seqno">   
                                    <input type="hidden" name="year">	    
                                    <input type="hidden" name="month">	    
                                    <input type="hidden" name="day">	  
                                ...
                                <form name="joinform4" method="post">
                                    <input type="hidden" name="trco_gb_cd">
                                    <input type="hidden" name="name">
                                    <input type="hidden" name="mbphn_no">
                                    <input type="hidden" name="cell_no1">
                                    <input type="hidden" name="cell_no2">
                                    <input type="hidden" name="cell_no3">
                                    <input type="hidden" name="hpon_no">
                                    <input type="hidden" name="res_no1">
                                    <input type="hidden" name="frnr"> 
                                    <input type="hidden" name="year">	    
                                    <input type="hidden" name="month">	    
                                    <input type="hidden" name="day">	
                                    ...
                                    <input type="hidden" name="depth_1" value="로그인">
                                    <input type="hidden" name="depth_2" value="회원가입">
                                    <input type="hidden" name="depth_3" value="">
                                    <input type="hidden" name="secuYn" value="Y">
                                    
                                    <input type="hidden" name="nationalinfo" id="nationalinfo" value="">
                                    
                                    <input type="hidden" name="flag" value="">
                                    
                                    <input type="hidden" name="isIpin" value="Y">
                                </form> 
                                <form name="ipinOutForm" id="ipinOutForm" method="post" action="WCM40102DS.jsp">
                                    <input type="hidden" name="isIpin" value="Y">
                                    <!--
                                    <input type="hidden" name="encPsnlInfo" />
                                    <input type="hidden" name="virtualno" />
                                    -->
                                    <input type="hidden" name="dupinfo" value="null">
                                    ...
                                    <input type="hidden" name="coinfo1" value="null">
                                    ...
                                    -->
                                    <input type="hidden" name="rsltCd">
                                    <input type="hidden" name="rsltMsg">
                                    <input type="hidden" name="vssn">
                                    <input type="hidden" name="trco_gb_cd" id="ipin_trco_gb_cd" value="A005301">
                                ...
                                <form name="findMembForm" id="findMembForm" method="post" action="WCM10110DS.jsp">
                                    <input type="hidden" name="ci">
                                    <input type="hidden" name="hpon_no">
                                    <input type="hidden" name="cust_nm">
                                    <input type="hidden" name="brth_dt">
                                    <input type="hidden" name="depth_1" value="로그인">
                                    <input type="hidden" name="depth_2" value="">
                                    <input type="hidden" name="depth_3" value="">
                                    <input type="hidden" name="flag" value="">
                                    <input type="hidden" name="loginflag" value="hp">
                                </form>
                                <!-- e : 휴대폰인증 영역  -->
                            </div> 
                            <!--  휴대폰인증 // --> 
            ...
            <section class="bottom-container hploginhide" style="">
                <div class="btn-content cta">
                    <div class="button-group">
                        <a href="javascript:void(0);" class="btn-secondary setShowInfo">취소</a> 
                        <a href="/mgcap/main/main.jsp;" class="btn-primary">메인으로</a>
                    </div>
                </div>
            </section>
