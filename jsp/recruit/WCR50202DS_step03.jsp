                        ...
                        <fieldset class="form-gruop">
                            ...
                            <div class="form-group">
                                <div class="date-wrap">
                                  ...
                                  <input id="milStart1" name="milStart1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                                <div class="date-wrap">
                                  <label for="milEnd1" class="sr-only">근무 종료일</label>
                                  <input id="milEnd1" name="milEnd1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                            </div>
                        </fieldset>
                    </td>
                        ...
                        <tr>
                            ...
                            <fieldset class="form-group">
                                ...
                                <div class="date-wrap">
                                  ...
                                  <input id="workStart" name="workStart" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                                <div class="date-wrap">
                                  <label for="workEnd" class="sr-only">근무 종료일</label>
                                  <input id="workEnd" name="workEnd" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                            </fieldset>
                            </td>
                        </tr>
