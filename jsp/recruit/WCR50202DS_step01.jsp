...
<form class="form-content">
    ...
    <div class="table-group">
        <h4 class="essential">지원분야</h4>
        <table class="td-l">
            <caption>지원구분 선택표(신입, 경력 포함)</caption>
            <colgroup>
                ...
                <tr>
                    ...
                    <td class="tal">
                        <fieldset class="radio-group">
                            ...
                            <label class="radio">
                                <input type="radio" name="classification" id="newApplicant" value="신입" checked>
                                <span>신입</span>
                            </label>
                            <label class="radio">
                                <input type="radio" name="classification" id="careerApplicant" value="경력">
                                <span>경력</span>
                            </label>
                        </fieldset>
                    </td>
    ...
    <!-- 1지망 -->
    <div class="table-group">
        <h4 class="essential">1지망</h4>
        <table class="td-l">
            <caption>1지망 입력표(희망근무지, 지원업무, 상세지원업무 포함)</caption>
                <colgroup>
    ...
    <!-- 2지망 -->
    <div class="table-group">
        <h4 class="essential">2지망</h4>
        <table class="td-l">
            <caption>2지망 입력표(희망근무지, 지원업무, 상세지원업무 포함)</caption>
                <colgroup>
                    <col style="width:33.3%">
                    <col style="width:33.3%">
                    <col style="width:auto">
    ...
    <!-- 개인정보 -->
    <div class="table-group">
        <h4 class="essential">개인정보</h4>
        <table class="td-l">
            <caption>개인정보 입력표(사진등록, 성명, 국적, 생년월일, 현주소, 전화번호, 휴대폰, 이메일, 취미, 특기 포함)</caption>
            <colgroup>
                <col style="width:262px">
                <col style="width:auto">
                <col style="width:262px">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <div class="photo-content" aria-labelledby="th-photo">
                            ...
                            <dl>
                                <dt class="rfrnc">사진등록</dt>
                                <dd> - 사진이미지의 권장사이즈는 103px*132px 입니다.</dd>
                                <dd>  - 다른 사이즈의 이미지를 업로드 할 경우 이미지가 비정상적으로 출력될 수 있습니다.</dd>
                                <dd>
                                    <span class="ipt-file">
                                        <button type="button" class="btn-form uploadButton">파일 선택</button>
                                        <label class="upload-label">
                                            <input id="files" class="upload" name="files" type="file" />
                                        </label>
    ...
    <div class="table-group">
        ...
        <p class="m-dot">면제사유는 해당자만 기입해주시기 바랍니다.</p>
    </div><!--//table-group-->
</form>