                            ...
                            <td class="tal">
                                <fieldset class="form-group">
                                    ...
                                    <div class="date-wrap">
                                        ...
                                        <input id="hsPeriodStart" name="hsPeriodStart" type="month" class="js-cal js-cal-month" placeholder="YYYY-MM">
                                    </div>
                                    <div class="date-wrap">
                                        <label for="hsPeriodEnd" class="sr-only">졸업</label>
                                        <input id="hsPeriodEnd" name="hsPeriodEnd" type="month" class="js-cal js-cal-month" placeholder="YYYY-MM">
                                    </div>
                                </fieldset>
                            </td>
                        ...
                        <td class="tal">
                            <fieldset class="form-group">
                                ...
                                <div class="date-wrap">
                                    ...
                                    <input id="techPeriodStart" name="techPeriodStart" type="month" class="js-cal js-cal-month" placeholder="YYYY-MM">
                                </div>
                                <div class="date-wrap">
                                    <label for="techPeriodEnd" class="sr-only">졸업</label>
                                    <input id="techPeriodEnd" name="techPeriodEnd" type="month" class="js-cal js-cal-month" placeholder="YYYY-MM">
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <td class="tal">
                        <fieldset class="form-group">
                            ...
                            <div class="date-wrap">
                                ...
                                <input type="month" id="univPeriodStart" name="univPeriodStart" class="js-cal js-cal-month" placeholder="YYYY-MM">
                            </div>
                            <div class="date-wrap">
                                <label for="univPeriodEnd" class="sr-only">졸업</label>
                                <input type="month" id="univPeriodEnd" name="univPeriodEnd" class="js-cal js-cal-month" placeholder="YYYY-MM">
                            </div>
                        </fieldset>
                    </td>
                        ...
                        <td class="tal">
                            <fieldset class="form-group">
                                ...
                                <div class="date-wrap">
                                    ...
                                    <input type="month" id="univPeriodStart2" name="univPeriodStart2" class="js-cal js-cal-month" placeholder="YYYY-MM">
                                </div>
                                <div class="date-wrap">
                                    <label for="univPeriodEnd2" class="sr-only">졸업</label>
                                    <input type="month" id="univPeriodEnd2" name="univPeriodEnd2" class="js-cal js-cal-month" placeholder="YYYY-MM">
                                </div>
                            </fieldset>
                        </td>
                    ...
                    <td class="tal">
                        <fieldset class="form-group">
                            ...
                            <div class="date-wrap">
                                ...
                                <input type="month" id="univPeriodStart3" name="univPeriodStart3" class="js-cal js-cal-month" placeholder="YYYY-MM">
                            </div>
                            <div class="date-wrap">
                                <label for="univPeriodEnd3" class="sr-only">졸업</label>
                                <input type="month" id="univPeriodEnd3" name="univPeriodEnd3" class="js-cal js-cal-month" placeholder="YYYY-MM">
                            </div>
                        </fieldset>
                    </td>
                ...
                <tbody>
                    ...
                    <td>
                        <div class="date-wrap">
                            ...
                            <input id="acquisitionEng1" name="acquisitionEng1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                        </div>
                    </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div calss="date-wrap">
                                ...
                                <input id="acquisitionEng2" name="acquisitionEng2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                ...
                                <input id="acquisitionEng3" name="acquisitionEng3" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                    </tr>
                    ...
                    <td>
                        <div class="date-wrap">
                            ...
                            <input id="acquisitionEng4" name="acquisitionEng4" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                        </div>
                    </td>
                    </tr>
                </tbody>
            ...
            <table class="td-l">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                <label for="acquisitionSec1" class="sr-only">취득일 3</label>
                                <input id="acquisitionSec1" name="acquisitionSec1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                ...
                                <input id="acquisitionSec2" name="acquisitionSec2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                ...
                                <input id="acquisitionSec3" name="acquisitionSec3" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                ...
                                <input id="acquisitionSec4" name="acquisitionSec4" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                    </tr>
                </tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                ...
                                <input id="licenseAcq1" name="licenseAcq1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                ...
                                <input id="licenseAcq2" name="licenseAcq2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                ...
                                <input id="licenseAcq3" name="licenseAcq3" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                ...
                                <input id="licenseAcq4" name="licenseAcq4" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="date-wrap">
                                ...
                                <input id="licenseAcq5" name="licenseAcq5" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </td>
                        <td>
                    ...
                    <td>
                        <fieldset class="form-group">
                            ...
                            <div class="date-wrap">
                                ...
                                <input id="stayStart1" name="stayStart1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                            <div class="date-wrap">
                                <label for="stayEnd1" class="sr-only">체류 종료일 1</label>
                                <input id="stayEnd1" name="stayEnd1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </fieldset>
                    </td>
                    <td>
                    ...
                    <td>
                        <fieldset class="form-group">
                            ...
                            <div class="date-wrap">
                                ...
                                <input id="stayStart2" name="stayStart2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                            <div class="date-wrap">
                                <label for="stayEnd2" class="sr-only">체류 종료일 2</label>
                                <input id="stayEnd2" name="stayEnd2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </fieldset>
                    </td>
                    <td>
                    ...
                    <td>
                        <fieldset class="form-group">
                            ...
                            <div class="date-wrap">
                                ...
                                <input id="stayStart3" name="stayStart3" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                            <div class="date-wrap">
                                <label for="stayEnd3" class="sr-only">체류 종료일 3</label>
                                <input id="stayEnd3" name="stayEnd3" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                            </div>
                        </fieldset>
                    </td>
                    <td>
                        ...
                        <td>
                            <fieldset class="form-group">
                                ...
                                <div class="date-wrap">                               
                                    ...
                                    <input id="clubStart1" name="clubStart1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                                <div class="date-wrap">
                                    <label for="clubEnd1" class="sr-only">활동 종료일 1</label>
                                    <input id="clubEnd1" name="clubEnd1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                            </fieldset>
                        </td>
                        <td>
                        ...
                        <td>
                            <fieldset class="form-group">
                                ...
                                <div class="date-wrap">
                                    ...
                                    <input id="clubStart2" name="clubStart2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                                <div class="date-wrap">
                                    <label for="clubEnd2" class="sr-only">활동 종료일 2</label>
                                    <input id="clubEnd2" name="clubEnd2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                            </fieldset>
                        </td>
                        <td>
                        ...
                        <td>
                            <fieldset class="form-group">
                                ...
                                <div class="date-wrap">
                                    ...
                                    <input id="clubStart3" name="clubStart3" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                                <div class="date-wrap">
                                    <label for="clubEnd3" class="sr-only">활동 종료일 3</label>
                                    <input id="clubEnd3" name="clubEnd3" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                            </fieldset>
                        </td>
                        <td>
                        ...
                        <td>
                            <fieldset class="form-group">
                                ...
                                <div class="date-wrap">
                                    ...
                                    <input id="volunteerStart1" name="volunteerStart1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                                <div class="date-wrap">
                                    <label for="volunteerEnd1" class="sr-only">활동 종료일 1</label>
                                    <input id="volunteerEnd1" name="volunteerEnd1" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                            </fieldset>
                        </td>
                        <td>
                        ...
                        <td>
                            <fieldset class="form-group">
                                ...
                                <div class="date-wrap">
                                    ...
                                    <input id="volunteerStart2" name="volunteerStart2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                                <div class="date-wrap">
                                    <label for="volunteerEnd2" class="sr-only">활동 종료일 2</label>
                                    <input id="volunteerEnd2" name="volunteerEnd2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                            </fieldset>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <fieldset class="form-group">
                                <legend class="sr-only">활동기간 3</legend>
                                <div class="date-wrap">
                                    <label for="volunteerStart2" class="sr-only">활동 시작일 3</label>
                                    <input id="volunteerStart2" name="volunteerStart2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                                <div class="date-wrap">
                                    <label for="volunteerEnd2" class="sr-only">활동 종료일 3</label>
                                    <input id="volunteerEnd2" name="volunteerEnd2" type="date" class="js-cal js-cal-date" placeholder="YYYY-MM-DD">
                                </div>
                            </fieldset>
                        </td>
